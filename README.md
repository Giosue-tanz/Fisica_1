...
1. Assicurarsi di avere una distribuzione TeX completa (es. TeX Live su Linux, MiKTeX su Windows).
2. Clonare il repository in locale:
   ```bash
   git clone https://github.com/Giosue-tanz/Appunti_di_Fisica_1.git
   ```
