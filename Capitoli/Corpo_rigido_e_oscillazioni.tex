...
\begin{equation*}
\left\langle \frac{dE}{dt} \right\rangle_T = \frac{1}{T} \int_t^{t+T} dt^* \left( \frac{dE}{dt^*} \right) = \frac{1}{T} [E(t+T) - E(t)] = 0 \quad \text{(moto periodico perché } E(t+T)=E(t)\text{. Lo verifichiamo:)}
\end{equation*}
