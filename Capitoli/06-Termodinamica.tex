...
\begin{tikzpicture}
    ...
    % Normal vector
    \draw[->, >=stealth, thick, mypen] (2.5, 0.75) -- (2.5, 2.5) node[right] {$\hat{n}$};
    
    % Force vector
    \draw[->, >=stealth, thick, mygreen, dashed] (2.5, 0.75) -- (3.5, 2) node[above right] {$\vec{F}$};
\end{tikzpicture}
\end{center}
\vspace{0.3cm}
...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}
        ...
        \draw[dashed, mypen] (0,0) -- (1,0.5) -- (4,0.5) -- (3,0);
        \draw[dashed, mypen] (0,2) -- (1,2.5) -- (4,0.5);
        \draw[thick, mypen] (3,0) -- (4,0.5);
        \node at (1.5,1) {P};
        \draw[->, >=stealth, thick, mygreen] (2,1.5) -- (2.5,2) node[above] {$\vec{F}$};
    \end{tikzpicture}
...
\begin{figure}[ht]
    \centering
    \begin{tikzpicture}
        \draw[thick, mypen] (0,0) rectangle (2,1);
        \draw[thick, mypen] (1,0) -- (1,1);
        \node at (0.5,0.5) {1};
        \node at (1.5,0.5) {2};
...
\centering
\begin{tikzpicture}
\draw[pattern=north east lines, mypen] (0,0) rectangle (3,0.2);
\draw[<->, >=stealth, mypen] (0,0.4) -- (3,0.4) node[midway,above] {$\ell$};
\end{tikzpicture}
\end{figure}
...
\centering
\begin{tikzpicture}
\draw[pattern=north east lines, mypen] (0,0) rectangle (2,1.5);
\node at (2.2, 0.75) {$a$};
\node at (1, 1.7) {$b$};
\node at (3, 0.75) {$S = a b$};
\end{tikzpicture}
...
\centering
\begin{tikzpicture}
\draw[mypen] (0,0) -- (2,0) -- (2,1) -- (0,1) -- cycle;
\draw[mypen] (0,1) -- (0.5,1.5) -- (2.5,1.5) -- (2,1);
\draw[mypen] (2,0) -- (2.5,0.5) -- (2.5,1.5);
\draw[pattern=north east lines, mypen] (0,0) -- (2,0) -- (2,1) -- (0,1) -- cycle;
\node at (1, -0.2) {$a$};
\node at (2.4, 0.2) {$b$};
\node at (2.7, 1) {$c$};
...
\centering
\begin{tikzpicture}
\draw[fill=gray!50, mypen] (0,0) rectangle (1,1);
\node at (0.5,0.5) {1};
\draw[fill=gray!50, mypen] (1.5,0) rectangle (2.5,1);
\node at (2,0.5) {2};
\end{tikzpicture}
\end{figure}
...
\draw[fill=gray!50, mypen] (0,0) rectangle (1,1);
\node at (0.5,0.5) {1};
\draw[fill=orange!50, mypen] (1.5,0) rectangle (2.5,1);
\node at (2,0.5) {2};
\end{tikzpicture}
\end{figure}
...
\centering
\begin{tikzpicture}
\draw[mypen] (0,0) rectangle (2, 2);
\draw[->, >=stealth, thick, mygreen] (0.5, 0.5) to[out=90, in=180] (1, 1.5) to[out=0, in=90] (1.5, 0.5);
\draw[->, >=stealth, thick, mygreen] (1.5, 0.5) to[out=270, in=0] (1, 0.2) to[out=180, in=270] (0.5, 0.5);
\draw[->, >=stealth, thick, notered] (1, -0.5) -- (1, 0) node[midway, right] {$Q$};
\node at (-1, 1) {Moti};
\node at (-1, 0.5) {convettivi};
\end{tikzpicture}
\end{figure}
...
\centering
\begin{tikzpicture}
\fill[pattern=north east lines, mypen] (0,0) rectangle (0.5, 2);
\draw[mypen] (0.5, 0) rectangle (2.5, 2);
\fill[pattern=north west lines, mypen] (2.5, 0) rectangle (3, 2);
\draw[->, >=stealth, mypen] (0.5, -0.5) -- (3, -0.5) node[right] {$x$};
\node at (0.25, 2.3) {$T_2$};
\node at (2.75, 2.3) {$T_1$};
\node at (1.5, 2.3) {$\Delta x$};
\draw[<->, >=stealth, mypen] (1, 1.5) -- (2, 1.5);
\node at (0.5, -0.5) {0};
\node at (2.5, -0.5) {$L$};
...
\centering
\begin{tikzpicture}
\draw[->, >=stealth, mypen] (0,0) -- (3,0) node[right] {$x$};
\draw[->, >=stealth, mypen] (0,0) -- (0,2.5) node[above] {$T$};
\node[left] at (0, 2) {$T_2$};
\node[left] at (0, 0.5) {$T_1$};
\node[below] at (2.5, 0) {$L$};
\draw[thick, mygreen] (0,2) -- (2.5, 0.5);
\end{tikzpicture}
\end{figure}
...
\centering
\begin{tikzpicture}
\draw[fill=mygreen!50, mypen] (0,0) rectangle (0.2, 1);
\node[above] at (0.1, 1) {$T+dT$};
\node[below] at (0.1, 0) {$dx$};
\draw[->, >=stealth, thick, notered] (0.2, 0.5) -- (0.8, 0.5) node[right] {$\delta Q$};
\node at (0.5, 1) {$T$};
\end{tikzpicture}
\end{figure}
...
\centering
\begin{tikzpicture}
\draw[mypen] (0,0) rectangle (1,2);
\draw[mypen] (1,0) rectangle (2,2);
\draw[mypen] (2,0) rectangle (3,2);
\node at (0.5, 1) {$k_1$};
\node at (1.5, 1) {$k_2$};
\node at (2.5, 1) {$k_3$};
...
\draw[->, >=stealth, notered] (0.5, 2.2) -- (1, 2.2) node[above] {$Q_1$};
\draw[->, >=stealth, notered] (1.5, 2.2) -- (2, 2.2) node[above] {$Q_2$};
\draw[->, >=stealth, notered] (2.5, 2.2) -- (3, 2.2) node[above] {$Q_3$};
...
\centering
\begin{tikzpicture}
\draw[mypen] (0,0) circle (1);
\draw[mypen] (-1,0) -- (1,0);
\draw[mypen] (0,-1) -- (0,1);
\draw[mypen] (-0.7,-0.7) -- (0.7,0.7);
\draw[mypen] (-0.7,0.7) -- (0.7,-0.7);
...
\begin{tikzpicture}
% Espansione
\draw[pattern=north east lines, mypen] (0,0) rectangle (0.5, 1.5);
\draw[mypen] (0.5, 0) rectangle (2, 1.5);
\draw[->, >=stealth, thick, mypen] (2, 0.75) -- (3, 0.75) node[right] {$F$};
\draw[<-, >=stealth, thick, notered] (0.5, 1.2) -- (1.5, 1.2) node[right] {$pS$};
\draw[<-, >=stealth, thick, mygreen] (0.5, 0.3) -- (1.5, 0.3) node[right] {$F_A$};
\node[above] at (2.5, 1) {Vuoto};
\node[below] at (1, -0.2) {Espansione};
\node[right] at (3.5, 0.75) {
    \parbox{8cm}{
    Equilibrio: $pS = F + F_A \implies F = pS - F_A < pS$ \\
    La forza da applicare è minore di quella senza attrito.
    }
};
...
\node[right] at (3.5, 0.75) {
    \parbox{8cm}{
    Equilibrio: $pS + F_A = F \implies F = pS + F_A > pS$ \\
    La forza da applicare è maggiore di quella senza attrito.
    }
};
\end{scope}
\end{tikzpicture}
...
\begin{tikzpicture}
    % Prima scatola A
    \draw[thick, mypen] (0,0) rectangle (1.5,1);
    \draw[mypen] (0.75,0) -- (0.75,1);
    \fill[pattern=north east lines, mypen] (0,0) rectangle (0.75,1);
    \node at (0.375, -0.3) {Stato A};

    \draw[->, >=stealth, thick, mypen] (1.8, 0.5) -- (2.5, 0.5);

    % Seconda scatola B
    \draw[thick, mypen] (2.8,0) rectangle (4.3,1);
    \fill[pattern=north east lines, mypen] (2.8,0) rectangle (4.3,1);
    \node at (3.55, -0.3) {Stato B};
\end{tikzpicture}
\end{center}

$Q=0$, $p_e=0 \implies \mathcal{L}=0 \implies \Delta U = 0 \implies$ \textbf{ISOTERMA (Boyle)}: $\;p_A V_A = p_B V_B$
...
\begin{tikzpicture}[scale=0.8]
    ...
    \draw[thick, color=mypen] (0.5,3.5) to[out=-70, in=160] (3.5,0.5) node[right] {\small Isoterma};
    \draw[thick, color=mygreen] (0.3,3.5) to[out=-80, in=170] (2,0.3) node[right] {\small Adiabatica};
\end{tikzpicture}
\end{center}
\end{minipage}\hfill
\begin{minipage}{0.56\textwidth}
Differenziando $pV^\gamma = \text{cost.}$:
\begin{align*}
...
\begin{align*}
    ...
    \gamma > 1 &\implies \text{curva più ripida (Adiabatica)}
\end{align*}
\end{minipage}
...
L'efficienza di questa macchina è descritta dal \textbf{Coefficiente di Prestazione (COP)}, definito come il rapporto tra l'effetto utile (il calore estratto dalla sorgente fredda) e il costo in termini di lavoro assor\section{Ciclo di Carnot e Teorema di Carnot}
...
\begin{tikzpicture}[scale=0.9]
    \draw[->, >=stealth, thick, mypen] (0,0) -- (0,3) node[left] {$p$};
    \draw[->, >=stealth, thick, mypen] (0,0) -- (3,0) node[below] {$V$};
...
\textbf{1) K vero, C falso}: si assume che K sia vero e C sia falso e si deduce un assurdo.
\begin{center}
\begin{minipage}{0.35\textwidth}
\begin{tikzpicture}[scale=0.9]
    % T2
    \draw[thick, mypen, fill=notered!30] (0, 3) rectangle (3, 4) node[midway] {$T_2 > T_1$};
    % T1
    \draw[thick, mypen, fill=cyan!30] (0, -1) rectangle (3, 0) node[midway] {$T_1$};
    
    % Macchina C
    \draw[thick, mypen] (0.75, 1.5) circle (0.5) node {$C$};
    \draw[->, >=stealth, thick, cyan] (0.75, 0) -- (0.75, 1) node[midway, left] {$Q_1$};
    \draw[->, >=stealth, thick, notered] (0.75, 2) -- (0.75, 3) node[midway, left] {$Q_1$};
    
    % Macchina Mc
    \draw[thick, mypen] (2.25, 1.5) circle (0.5) node {$M_C$};
    ...
    \draw[->, >=stealth, thick, mypen] (2.75, 1.5) -- (3.5, 1.5) node[right] {$L$};
...
\begin{itemize}
    ...
    \item $T_2$ cede $Q_2$ e assorbe $Q_1 \implies Q_{T2} = Q_2 - |Q_1|$
    \item il sistema combinato è ciclico.
    Essendo $\Delta U_{tot} = 0 \implies L = Q_2 - |Q_1| > 0$
\end{itemize}
$\implies T_1$ non interviene: abbiamo un ciclo monotermo con unica sorgente $T_2$ da cui viene estratto calore per convertirlo integralmente in lavoro ($L > 0$). Questo viola l'enunciato di Kelvin-Planck, che per Hp era vero.\\
Assurdo. Dunque se Kelvin-Planck è vero, anche Clausius lo è.
\end{minipage}
\end{center}

\vspace{0.3cm}
\textbf{2) C vero, K falso}: si assume che C sia vero e K sia falso e si deduce un assurdo.
\begin{center}
\begin{minipage}{0.35\textwidth}
\begin{tikzpicture}
    % T1
    \draw[thick, mypen, fill=cyan!30] (0, 3) rectangle (1.5, 4) node[midway] {$T_1$};
    
    % Macchina K
    \draw[thick, mypen] (0.75, 1.5) circle (0.5) node {$K$};
    \draw[<-, >=stealth, thick, cyan] (0.75, 2) -- (0.75, 3) node[midway, right] {$Q$};
    \draw[->, >=stealth, thick, mypen] (1.25, 1.5) -- (2.5, 1.5) node[midway, above] {$L$};
    
    % Attrito
    \draw[thick, dashed, mypen] (2.5, 1) rectangle (4, 2) node[midway] {attrito};
    \draw[->, >=stealth, thick, notered] (4, 1.5) -- (5, 1.5) node[midway, above] {$Q$};
    
    % T2
    \draw[thick, mypen, fill=notered!30] (5, 1) rectangle (6.5, 2) node[midway] {$T_2 > T_1$};
\end{tikzpicture}
\end{minipage}
\begin{minipage}{0.6\textwidth}
\begin{itemize}
    ...
    \item l'attrito trasforma integralmente $L$ in calore $Q$
\end{itemize}
$\implies$ La macchina composta assorbe $Q$ da $T_1$ e lo cede interamente a $T_2$, senza alcun lavoro netto immesso. Questo viola l'enunciato di Clausius, che per Hp era vero. 
Assurdo. Dunque se Clausius è vero, anche Kelvin-Planck lo è.
\end{minipage}
\end{center}
...
\draw[->, thick, mypen] (1, 0) -- (1, 1) node[midway, right] {$Q_B$};
\draw[->, thick, mypen] (1, 2) -- (1, 3) node[midway, right] {$Q_A, Q_{AC}$};
\end{tikzpicture}
\end{figure}
