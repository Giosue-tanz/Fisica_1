...
\begin{tikzpicture}[scale=1]
    ...
    \fill[boxoss!15, opacity=0.8] (0,0) -- (4,0) -- (5,1.5) -- (1,1.5) -- cycle;
    ...
    \draw[->, >=stealth, thick, boxoss] (P) -- (2.5, 2.3) node[left, midway] {$F_\perp$};
\end{tikzpicture}
...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}[scale=1.1]
        ...
        \fill[boxoss!15, opacity=0.8] (0,0) -- (3,0) -- (0,2) -- cycle;
...
\begin{teorema}{Spinta di Archimede}
...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}
        ...
        \draw[thick, mypen, fill=boxoss!30] (0.1,0.1) rectangle (2.9,0.8); % liquido in vaschetta
        \draw[thick, mypen] (1.3,0.5) -- (1.3,4) -- (1.7,4) -- (1.7,0.5); % tubo
        \draw[thick, mypen, fill=boxoss!30] (1.3,0.5) rectangle (1.7,3); % liquido in tubo
...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}[scale=0.95]
        ...
        % Sistema A e B
        \draw[thick, mypen, fill=boxoss!10] (0.5,1.5) rectangle (2.8,2.6) node[midway, font=\bfseries] {Sistema A ($T_A$)};
        \draw[thick, mypen, fill=boxteo!10] (3.2,1.5) rectangle (5.5,2.6) node[midway, font=\bfseries] {Sistema B ($T_B$)};
        
        % Sistema C (Termometro/riferimento in contatto diatermico con A e B)
        \draw[thick, mypen, fill=boxese!10] (0.5,0.4) rectangle (5.5,1.3) node[midway, font=\bfseries] {Sistema C ($T_C$) - Parete Diatermica};
...
\begin{teorema}{Legge di Dalton delle Pressioni Parziali}
...
\centering
\begin{tikzpicture}[scale=1.1]
\fill[boxoss!15, opacity=0.8] (0,0) rectangle (2.5,1.8);
...
\fill[boxteo!15, opacity=0.8] (0,0) -- (2.5,0) -- (2.5,1.5) -- (0,1.5) -- cycle;
\fill[boxteo!25, opacity=0.8] (0,1.5) -- (0.8,2.1) -- (3.3,2.1) -- (2.5,1.5) -- cycle;
\fill[boxteo!35, opacity=0.8] (2.5,0) -- (3.3,0.6) -- (3.3,2.1) -- (2.5,1.5) -- cycle;
...
\draw[thick, boxoss] plot [smooth] coordinates {(0.2, 1.5) (0.3, 0) (0.5, -2.5) (1, -1.5) (2, -0.5) (3.5, -0.1)};
\draw[dashed, mypen] (0.5, -2.5) -- (0, -2.5) node[left] {$E_{\text{min}}$};
...
Se aumentiamo l'energia del sistema al valore $E_1 > E_{\text{min}}$, si ottengono due punti di inversione del moto.
...
\draw[thick, fill=boxoss!20] (0,0) rectangle (1.4,1.2) node[midway, font=\bfseries] {$m_1, T_1$};
\draw[thick, fill=boxoss!40] (1.6,0) rectangle (3,1.2) node[midway, font=\bfseries] {$m_2, T_2$};
...
\fill[pattern=north east lines, mypen!20] (-0.3,-0.3) rectangle (3.3,1.5);
\draw[thick, mypen] (-0.3,-0.3) rectangle (3.3,1.5);
\draw[thick, fill=boxoss!20] (0,0) rectangle (1.4,1.2) node[midway, font=\bfseries] {$C_1, T_1$};
\draw[thick, fill=boxteo!30] (1.6,0) rectangle (3,1.2) node[midway, font=\bfseries] {$C_2, T_2$};
...
Un tipico esempio è quello del calore latente di fusione $(\Delta Q)_{\text{fus}}$ o di solidificazione $(\Delta Q)_{\text{sol}}$ dell'acqua ($\mathrm{H_2O}$).
...
\draw[thick, boxoss] (-0.5, -0.5) to[out=45, in=200] (0.5, 1);
\draw[thick, boxoss] (0.5, 1) -- (2.5, 1);
\draw[thick, boxoss] (2.5, 1) to[out=20, in=260] (3.5, 2.5);
...
\centering
\begin{tikzpicture}[scale=1]
\fill[boxoss!10] (0,0) rectangle (2.5, 2.2);
...
\draw[->, >=stealth, thick, boxoss] (1.9, 0.4) to[out=270, in=0] (1.25, 0.1) to[out=180, in=270] (0.6, 0.4);
...
\begin{teorema}{Legge di Newton (empirica)}
...
\draw[thick, mypen, fill=boxteo!10] (0.6, 0) rectangle (3.4, 2);
\fill[pattern=north west lines, boxoss!25] (3.4, 0) rectangle (4, 2);
...
\node[left, font=\bfseries, boxoss] at (0, 0.6) {$T_1$};
...
\begin{teorema}{Legge di Fourier}
...
\draw[thick, fill=boxteo!20] (0,0) rectangle (0.6, 1.5);
...
\draw[thick, fill=boxteo!10] (0,0) rectangle (1.2,2.5) node[midway] {$k_1$};
\draw[thick, fill=boxteo!15] (1.2,0) rectangle (2.6,2.5) node[midway] {$k_2$};
\draw[thick, fill=boxese!10] (2.6,0) rectangle (4,2.5) node[midway] {$k_3$};
\fill[pattern=north west lines, boxoss!20] (4,0) rectangle (4.4,2.5);
...
\node[right, font=\bfseries, boxoss] at (4, 2.8) {$T_1$};
...
\begin{teorema}{Legge di Stefan-Boltzmann}
...
\begin{tikzpicture}
    % Sistema generico
    \draw[thick, fill=boxoss!10, mypen] (0,0) circle (2);
    \node at (0,0) {Sistema};
    % Frecce di scambio
...
\draw[thick, mypen, fill=boxoss!10] (0.6, 0) rectangle (2.2, 1.6);
\draw[thick, fill=mypen!30] (2.2, 0) rectangle (2.4, 1.6);
...
\node[below, font=\bfseries, boxoss] at (1.4, -0.2) {Espansione ($dV > 0$)};
\node[right] at (4, 0.8) {
    \parbox{7cm}{\small
...
\fill[pattern=north east lines, mypen!20] (0,0) rectangle (0.6, 1.6);
\draw[thick, mypen] (0,0) rectangle (0.6, 1.6);
\draw[thick, mypen, fill=boxteo!10] (0.6, 0) rectangle (2.2, 1.6);
\draw[thick, fill=mypen!30] (2.2, 0) rectangle (2.4, 1.6);
\draw[<-, >=stealth, thick, mypen, line width=1.2pt] (2.4, 0.8) -- (3.6, 0.8) node[right, font=\bfseries] {$F$};
\draw[->, >=stealth, thick, notered] (0.6, 1.3) -- (1.8, 1.3) node[right] {$pS$};
\draw[<-, >=stealth, thick, mygreen] (0.6, 0.3) -- (1.8, 0.3) node[right] {$F_A$};
...
\begin{teorema}{Primo Principio della Termodinamica}
...
\begin{tikzpicture}
    ...
    \fill[boxoss!10, opacity=0.5] (1,0) -- (1,3) to[out=-60, in=150] (4,1) -- (4,0) -- cycle;
    
    % Trasformazione
    \draw[thick, boxoss, ->, >=stealth] (1,3) to[out=-60, in=150] (4,1);
...
\begin{teorema}{Legge di Dulong e Petit per i Solidi}
...
\begin{tikzpicture}
    ...
    % Acqua
    \fill[boxoss!20] (0.2, 0.2) rectangle (2.8, 2);
...
\begin{formulario}{Le Quattro Trasformazioni Notevoli di un Gas Perfetto}
\centering
\renewcommand{\arraystretch}{1.6}
\begin{tabular}{@{}l l l l l@{}}
\toprule
\textbf{Trasformazione} & \textbf{Invariante} & $\boldsymbol{L}$ & $\boldsymbol{Q}$ & $\boldsymbol{\Delta U}$ \\
\midrule
Isoterma ($T$ cost.)   & $pV = \text{cost.}$          & $nRT \ln\dfrac{V_B}{V_A}$ & $= L$              & $0$ \\
Isocora ($V$ cost.)    & $p/T = \text{cost.}$         & $0$                       & $n c_v \Delta T$   & $= Q$ \\
Isobara ($p$ cost.)    & $V/T = \text{cost.}$         & $p \, \Delta V$           & $n c_p \Delta T$   & $n c_v \Delta T$ \\
Adiabatica ($Q = 0$)   & $pV^{\gamma} = \text{cost.}$ & $-n c_v \Delta T$         & $0$                & $n c_v \Delta T$ \\
\bottomrule
\end{tabular}
\vspace{4pt}

\raggedright
con $\gamma = c_p/c_v$ e, per i gas perfetti, la relazione di Mayer $c_p - c_v = R$.
\end{formulario}
...
\begin{tikzpicture}[scale=1.1]
    ...
    \draw[step=1cm, mypen!15, very thin] (0,0) grid (5.2,5.2);
    ...
    % Isobara (p = 3)
    \draw[thick, boxteo] (0.8, 3) -- (4.8, 3) node[right] {\small Isobara};
    
    % Isoterma (p = 6/V)
    \draw[thick, boxoss, domain=1.2:4.8, samples=50] plot (\x, {6/\x}) node[right] {\small Isoterma};
    ...
    \draw[dashed, mypen!55] (2,0) node[below] {$V_0$} -- (2,3) -- (0,3) node[left] {$p_0$};
...
\begin{teorema}{Enunciati del Secondo Principio}
...
\begin{tikzpicture}
    ...
    % Macchina Termica
    \draw[thick, mypen, fill=mypen!20] (3,2.5) circle (0.8);
    \node at (3,2.5) {M.T.};
    
    % Sorgente Fredda
    \draw[thick, mypen, fill=boxoss!30] (2,0) rectangle (4,1);
    \node at (3,0.5) {Sorgente $T_f$};
    
    % Frecce
    \draw[->, >=stealth, thick, notered] (3,4) -- (3,3.3) node[midway, right] {$Q_c$};
    \draw[->, >=stealth, thick, boxoss] (3,1.7) -- (3,1) node[midway, right] {$Q_f$};
...
\begin{tikzpicture}[scale=1.1]
    ...
    \draw[thick, fill=boxoss!20] (0,0) rectangle (2.3,1.5);
    \fill[pattern=north west lines, boxoss!40] (0,0) rectangle (2.3,1.5);
    \draw[thick, mypen, line width=1.5pt] (2.3,0) -- (2.3,1.5);
    \node[font=\bfseries] at (1.15, 0.75) {Gas ($V_A, T_A$)};
    \node[font=\bfseries, mypen!55] at (3.75, 0.75) {Vuoto ($p=0$)};
    ...
    \fill[white] (0,0) rectangle (5.2,1.5);
    \draw[thick, mypen] (0,0) rectangle (5.2,1.5);
    \draw[thick, fill=boxoss!15] (0,0) rectangle (5.2,1.5);
...
\begin{tikzpicture}[scale=1]
    % Griglia
    \draw[step=1cm, mypen!15, very thin] (0,0) grid (4.2,4.2);
    % Assi
    ...
    \draw[thick, boxoss, domain=1.0:3.8, samples=40] plot (\x, {3.96/\x}) node[right] {\small Isoterma};
    ...
    \draw[thin, boxoss!70, dashed, domain=1.1:2.7] plot (\x, {4.4 - 1.22*\x});
    ...
    \draw[dashed, mypen!55] (1.8,0) node[below] {$V_0$} -- (1.8,2.2) -- (0,2.2) node[left] {$p_0$};
\end{tikzpicture}
\end{minipage}\hfill
...
\begin{tikzpicture}
    ...
    \draw[->, >=stealth, thick, boxoss] (3,1) -- (3,1.7) node[midway, right] {$Q_f$};
    \draw[<-, >=stealth, thick, mypen] (3.8, 2.5) -- (5, 2.5) node[midway, above] {$|L|$};
\end{tikzpicture}
...
\begin{tikzpicture}[scale=1.1]
    % Griglia
    \draw[step=1cm, mypen!15, very thin] (0,0) grid (4.5,4.5);
    % Assi
    ...
    \draw[thick, boxoss, domain=1.2:3.0, samples=30] plot (\x, {4.8/\x});
    \node[right, boxoss] at (2.9, 1.8) {$T_2$};
    ...
    \draw[thick, boxoss, domain=1.6:4.0, samples=30] plot (\x, {2.4/\x});
    \node[right, boxoss] at (3.9, 0.4) {$T_1$};
    ...
    \fill[boxoss!15, opacity=0.7, domain=1.2:3.0, variable=\x] (1.2,4.0) -- plot (\x, {4.8/\x}) -- (3.0,1.6) -- (3.0,0.8) -- plot[domain=3.0:1.6] (\x, {2.4/\x}) -- (1.6,1.5) -- plot[domain=1.6:1.2] (\x, {5.13/(\x^1.4)}) -- cycle;
...
\begin{teorema}{Teorema di Carnot}
...
\begin{tikzpicture}[scale=1.05]
    ...
    \draw[->, >=stealth, thick, boxoss] (0.75, 0) -- (0.75, 1) node[left, midway] {$Q_{1C}$};
    ...
    \draw[->, >=stealth, thick, boxoss] (2.25, 1) -- (2.25, 0) node[right, midway] {$Q_1$};
    % Lavoro prodotto da M (freccia uscente da M verso destra)
    \draw[->, >=stealth, thick, mypen] (2.75, 1.5) -- (3.3, 1.5) node[right] {$L$};
    
    % Sorgente FREDDA T1
    \draw[thick, mypen, fill=boxoss!20, rounded corners=2pt] (0, -0.8) rectangle (3, 0) node[midway, font=\bfseries] {Sorgente Fredda $T_1$};
\end{tikzpicture}
\end{minipage}\hfill
\begin{minipage}{0.54\textwidth}
...
Per il Secondo Principio (enunciato di Kelvin-Planck), il lavoro totale prodotto non può essere positivo (non si può estrarre calore da un'unica sorgente $T_1$ e produrre lavoro netto). Quindi $L_{\text{tot}} \le 0 \implies L - |L_C| \le 0$. Da questo limite termodinamico deriva la disuguaglianza sui rendimenti:
\begin{itemize}
...
\begin{tikzpicture}[scale=1.1]
    % Griglia
    \draw[step=1cm, mypen!15, very thin] (0,0) grid (3.8,3.2);
    % Assi
    ...
    % A->B Isoterma
    \draw[thick, boxoss, domain=1.0:3.0, samples=30] plot (\x, {1.5/\x});
    % B->C Adiabatica
    ...
    \draw[->, >=stealth, thick, boxoss] (1.8, {1.5/1.8}) -- (1.9, {1.5/1.9});
    ...
    \node[below, boxoss] at (2.0, 0.7) {\small Isoterma ($T_1$)};
...
\begin{equation}
\begin{split}
    L_{\text{tot}} &= L_{AB} + L_{BC} + L_{CA} \\
                   &= n R T_1 \ln\!\left(\frac{V_B}{V_A}\right) - n c_v (T_2 - T_1)
\end{split}
\end{equation}
...
\begin{tikzpicture}[scale=0.95]
    ...
    % T1
    \draw[thick, mypen, fill=boxoss!20, rounded corners=2pt] (0, -0.8) rectangle (3, 0) node[midway, font=\bfseries] {Sorgente $T_1$};
    
    % Macchina anti-Clausius C
    \draw[thick, mypen, fill=white] (0.75, 1.5) circle (0.5) node[font=\bfseries] {$C$};
    \draw[->, >=stealth, thick, boxoss] (0.75, 0) -- (0.75, 1) node[midway, left] {$Q_1$};
    ...
    \draw[->, >=stealth, thick, boxoss] (2.25, 1) -- (2.25, 0) node[midway, right] {$Q_1$};
...
\begin{tikzpicture}[scale=0.9]
    % T1
    \draw[thick, mypen, fill=boxoss!20, rounded corners=2pt] (0, 3) rectangle (1.8, 4) node[midway, font=\bfseries] {Sorgente $T_1$};
    
    % Macchina anti-Kelvin K
    \draw[thick, mypen, fill=white] (0.9, 1.5) circle (0.5) node[font=\bfseries] {$K$};
    \draw[->, >=stealth, thick, boxoss] (0.9, 3) -- (0.9, 2) node[midway, right] {$Q$};
    \draw[->, >=stealth, thick, mypen] (1.4, 1.5) -- (2.6, 1.5) node[midway, above] {$L$};
    
    % Attrito / Dissipatore
    \draw[thick, dashed, mypen, fill=boxteo!15, rounded corners=2pt] (2.6, 0.8) rectangle (4.2, 2.2) node[midway, align=center, font=\small] {Dissipatore\\(attrito)};
...
\begin{formulario}{Rendimenti e Secondo Principio}
\begin{minipage}[t]{0.47\textwidth}
\textbf{Macchina termica}
\begin{equation*}
...
\textbf{Teorema di Carnot.} Fra due sorgenti a temperature $T_c > T_f$ nessuna macchina può superare
il rendimento della macchina reversibile, e tutte le macchine reversibili hanno lo stesso rendimento:
\begin{equation*}
    \eta \leq \eta_{\text{Carnot}} = 1 - \frac{T_f}{T_c}
    \qquad
    \begin{cases}
        \eta = \eta_{\text{Carnot}} & \text{ciclo reversibile} \\
        \eta < \eta_{\text{Carnot}} & \text{ciclo irreversibile}
    \end{cases}
\end{equation*}

\textbf{Disuguaglianza di Clausius.} Su un ciclo qualsiasi
\begin{equation*}
    \oint \frac{\delta Q}{T} \leq 0
    \qquad\qquad
    \Delta S_{\text{universo}} \geq 0
\end{equation*}
con l'uguaglianza valida se e solo se il ciclo è reversibile.
\end{formulario}
...
\begin{figure}[ht]
    \centering
    \begin{tikzpicture}[>=stealth, scale=1.25, font=\small]
        % Assi
        \draw[->, thick, mypen] (0,0) -- (3.4,0) node[right] {$V$};
        \draw[->, thick, mypen] (0,0) -- (0,3.2) node[above] {$p$};

        % Stati estremi
        \fill[notered] (0.6,2.3) circle (2.2pt) node[above left, mypen] {$A$};
        \fill[notered] (2.8,0.6) circle (2.2pt) node[right, mypen] {$B$};

        % Cammino I: irreversibile, A -> B
        \draw[->, very thick, boxatt, dashed]
            (0.6,2.3) to[out=-20, in=130] (1.7,1.45) to[out=-50, in=172] (2.8,0.6);
        \node[boxatt, above right] at (1.75,1.5) {I \; (irrev.)};

        % Cammino II: reversibile, B -> A
        \draw[->, very thick, boxese]
            (2.8,0.6) to[out=192, in=-30] (1.6,0.95) to[out=150, in=-75] (0.6,2.3);
        \node[boxese, below left] at (1.55,0.9) {II \; (rev.)};
    \end{tikzpicture}
    \caption{Ciclo impiegato per ricavare la disuguaglianza di Clausius in forma aperta: il sistema va da $A$ a $B$ lungo la trasformazione irreversibile I e ritorna da $B$ ad $A$ lungo la trasformazione reversibile II. Applicando $\oint \delta Q / T < 0$ al ciclo complessivo si ottiene $\Delta S \geq \int_A^B \delta Q / T$.}
    \label{fig:disuguaglianza_clausius}
\end{figure}
...
\begin{teorema}{Formulazione Entropica del Secondo Principio della Termodinamica}
...
\begin{tikzpicture}
    ...
    \draw[dashed, thick, notered] (0, 3) node[left] {$S_{\text{max}}$} -- (5.8, 3);
    \draw[thick, boxoss] (0.2, 0.5) to[out=60, in=185] (1.5, 2.0) to[out=5, in=190] (3.0, 2.7) to[out=10, in=180] (5.5, 3.0);
...
\begin{tikzpicture}[scale=1.05]
    ...
    % Isoterma (T = 1.2)
    \draw[thick, boxoss] (1.2, 1.2) -- (4.0, 1.2) node[right] {\small Isoterma};
    ...
    \draw[thick, boxteo, domain=1.2:3.6, samples=30] plot (\x, {1.2*exp((\x-1.2)/2.0)}) node[right] {\small Isobara};
    
    % Punto A
    \filldraw[mypen] (1.2, 1.2) circle (1.8pt) node[below left] {$A(S_0, T_0)$};
    \draw[dashed, mypen!55] (1.2,0) node[below] {$S_0$} -- (1.2,1.2) -- (0,1.2) node[left] {$T_0$};
\end{tikzpicture}
\end{minipage}\hfill
\begin{minipage}{0.50\textwidth}
...
\begin{tikzpicture}[scale=1.1]
    % Griglia
    \draw[step=1cm, mypen!15, very thin] (0,0) grid (4.2,3.8);
    % Assi
    ...
    \fill[boxoss!15, opacity=0.8] (1.2, 1.0) rectangle (3.4, 3.0);
    
    % Ciclo
    \draw[thick, boxoss, ->, >=stealth] (1.2, 3.0) -- (2.4, 3.0);
    \draw[thick, boxoss] (2.4, 3.0) -- (3.4, 3.0) node[above, midway] {$Q_2 > 0$};
    
    \draw[thick, notered, ->, >=stealth] (3.4, 3.0) -- (3.4, 2.0);
    \draw[thick, notered] (3.4, 2.0) -- (3.4, 1.0);
    
    \draw[thick, boxoss, ->, >=stealth] (3.4, 1.0) -- (2.3, 1.0);
    \draw[thick, boxoss] (2.3, 1.0) -- (1.2, 1.0) node[below, midway] {$Q_1 < 0$};
    ...
    % Coordinate
    \draw[dashed, mypen!55] (1.2, 0) node[below] {$S_A$} -- (1.2, 1.0);
    \draw[dashed, mypen!55] (3.4, 0) node[below] {$S_B$} -- (3.4, 1.0);
    \draw[dashed, mypen!55] (0, 3.0) node[left] {$T_2$} -- (1.2, 3.0);
    \draw[dashed, mypen!55] (0, 1.0) node[left] {$T_1$} -- (1.2, 1.0);
...
\draw[thick, mypen, fill=boxteo!15] (0, 3) rectangle (3, 4) node[midway, font=\bfseries] {Sorgente Calda ($T_B$)};
\node[left, font=\bfseries, notered] at (0, 3.5) {$T_B > T_A$};

% Macchina Termica
\draw[thick, mypen, fill=boxoss!15] (1.5, 1.5) circle (0.6);
\node[font=\bfseries] at (1.5, 1.5) {$M / M_C$};

% Sorgente Fredda
\fill[pattern=north west lines, boxoss!25] (0, -1) rectangle (3, 0);
\draw[thick, mypen, fill=boxoss!10] (0, -1) rectangle (3, 0) node[midway, font=\bfseries] {Sorgente Fredda ($T_A$)};
\node[left, font=\bfseries, boxoss] at (0, -0.5) {$T_B > T_A$};

% Frecce di scambio termico
\draw[->, >=stealth, thick, notered, line width=1.5pt] (1.5, 3) -- (1.5, 2.1) node[midway, right, font=\bfseries] {$Q_B$};
\draw[->, >=stealth, thick, boxoss, line width=1.5pt] (1.5, 0.9) -- (1.5, 0) node[midway, right, font=\bfseries] {$Q_A$ (o $Q_{AC}$)};
